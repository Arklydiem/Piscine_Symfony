...
class UserController extends AbstractController
{
    ...
    #[Route('/e08/createTable', name: 'createTable', methods: ['GET', 'POST'])]
     ...
     */
    #[Route('/e08/createUser', name: 'createUser', methods: ['POST', 'GET'])]
    ...
    #[Route('/e08', name: 'getUsers', methods: ['GET'])]
    ...
    #[Route('/e08/delete/{id}', name: 'deleteUser', methods: ['POST', 'GET'])]
    ...
    #[Route('/e08/update/{id}', name: 'updateUser', methods: ['GET', 'POST'])]
    ...
    #[Route('/e08/search', name: 'searchUsers', methods: ['GET'])]

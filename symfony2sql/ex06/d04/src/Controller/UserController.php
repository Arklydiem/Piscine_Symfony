...
class UserController extends AbstractController
{
    ...
    #[Route('/e06/createTable', name: 'createTable', methods: ['GET', 'POST'])]
     ...
     */
    #[Route('/e06/createUser', name: 'createUser', methods: ['POST', 'GET'])]
    ...
    #[Route('/e06', name: 'getUsers', methods: ['GET'])]
    ...
    #[Route('/e06/delete/{id}', name: 'deleteUser', methods: ['POST', 'GET'])]
    ...
    #[Route('/e06/update/{id}', name: 'updateUser', methods: ['GET', 'POST'])]
    public function updateUser(int $id, Request $request): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            if ($result) {
                ...
                $this->addFlash('message', 'Error updating the user.');
            }

...
class UserController extends AbstractController
{
    ...
    #[Route('/e10/createTable', name: 'createTable', methods: ['GET', 'POST'])]
     ...
     */
    #[Route('/e10/createUser', name: 'createUser', methods: ['POST', 'GET'])]
    ...
    #[Route('/e10', name: 'getUsers', methods: ['GET'])]
    ...
    #[Route('/e10/delete/{id}', name: 'deleteUser', methods: ['POST', 'GET'])]
    ...
    #[Route('/e10/update/{id}', name: 'updateUser', methods: ['GET', 'POST'])]
    ...
    #[Route('/e10/search', name: 'searchUsers', methods: ['GET'])]
    ...
    #[Route('/e10/users', name: 'sortedUsers', methods: ['GET'])]
